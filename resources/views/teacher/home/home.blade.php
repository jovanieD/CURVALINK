...
@section('teacher')
        ...
        <div class="container py-5">
            ...
            <div class="row g-5">
                <div class="col-md-6 wow zoomIn" data-wow-delay="0.3s">
                    <div class="service-item rounded d-flex flex-column align-items-center justify-content-center text-center bg-white rounded shadow position-relative text-wrap h-100"
                        style="z-index: 1;">
                        ...
                        <div class="w-75">
                            <p class="mb-5" style="text-align: center">Expresses one’s spiritual beliefs while
                                respecting the spiritual beliefs of others Shows adherence to ethical principles by
                                upholding truth</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 wow zoomIn" data-wow-delay="0.4s">
                    <div class="service-item rounded d-flex flex-column align-items-center justify-content-center text-center bg-white rounded shadow position-relative text-wrap h-100"
                        ...
                        <div class="w-75">
                            <p class="mb-5" style="text-align: center">Is sensitive to individual, social, and cultural
                                differences <br> Demonstrates contributions toward solidarity</p>
                        </div>
                    </div>
                </div>
    ...
    <div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container py-5">
            <div class="section-title text-center position-relative pb-3 mb-5 mx-auto" style="max-width: 600px;">
                <h5 class="fw-bold text-primary text-uppercase">MMNHS Blog</h5>
