...
@section('teacher')
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <div class="row mb-2">
                        <div class="col-md-6">
                            ...
                            <a href="/teacher/all_events">
                                <i class="fa-solid fa-arrows-rotate  fa-xl m-1 "></i></a>
                            <a href="/teacher/add_event"><button id="addScheduleButton" class="btn btn-info m-2">+
                                    Add Events</button></a>

                        </div>

                        <div class="col-md-6">
                            <form method="GET" action="{{ route('eventSearch') }}" class="form-inline">
                                @csrf
                    ...
                    <div class="card">
                        ...
                        <div class="table-responsive text-nowrap">
                            <table class="table">
                                ...
                                <tbody class="table-border-bottom-0">
                                    ...
                                    @include('teacher.actions.viewonlyevents')
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    @endphp
                                                    @include('modals.teacherdeleteevent')
                                                    <div class="dropdown-menu" style="z-index: 1000;">
                                                        <a class="dropdown-item viewonlyevent" style="cursor: pointer;"
                        ...
                        <nav class="d-flex justify-content-center m-2">
                            <ul class="pagination">
                                {{ $events->onEachSide(1)->setPath('/teacher/all_event')->appends(request()->query())->links('pagination::bootstrap-4') }}
                            </ul>
                        </nav>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            $('.viewonlyevent').on('click', function() {
