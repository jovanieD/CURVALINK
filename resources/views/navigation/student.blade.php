                    ...
                    <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button"
                        ...
                        <span class="m-2">
                            <img style="border-radius: 25px; height: 30px; width: 30px;"
                                src="<?php echo asset("storage/app/{{Auth::user()->profile_image}}")?>" type="image/jpeg" alt="">
                        </span>
                    </a>
                                ...
                                <div class="d-flex">
                                    <div class="flex-shrink-0 me-3">
                                        <div class="avatar avatar-online">
                                            <img src="<?php echo asset("storage/app/{{Auth::user()->profile_image}}")?>" alt class="rounded-circle"
