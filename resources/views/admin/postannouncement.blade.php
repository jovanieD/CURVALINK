        ...
        <div class="layout-container">
            ...
            <div class="content-wrapper">
                ...
                <div class="container mt-4">
                    <div class="row mb-2">
                        <div class="col-md-6">
                            <a href="/admin/all_announcements" class=" m-4">
                                <i class="fa-solid fa-arrow-left fa-xl m-1 bg-warning"></i>
                            </a>
                            <a href="/admin/add_announcement">
                ...
                <section>
                    <div class="container py-5">
                        ...
                        <form action="/admin_post_announcement" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="card mb-4">
                                        <div class="card-body text-center">
                                            ...
                                            <div>
                                                <div class="mb-4 d-flex justify-content-center">
                                                    <img id="selectedImage" src="/images/announcement.png"
