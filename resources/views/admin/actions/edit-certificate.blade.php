    ...
    <div class="layout-wrapper layout-content-navbar">
        <div class="layout-container">
            <div class="content-wrapper">
                ...
                <form action="/admin_certificaterequest/{{ $data['id'] }}/update" method="post" accept-charset="utf-8" autocomplete="on">
                    @csrf
                        ...
                        <ul class="form-section page-section">
                            ...
                            <li class="form-line jf-required " data-type="control_textarea" id="id_32"><label
                                ...
                                <div id="cid_32" class="form-input-wide jf-required " data-layout="full">
                                    <textarea id="input_32"  maxlength="300" class="form-textarea validate[]" name="purpose"
