<div class="modal fade" id="teacherdeleteevent{{$event['id']}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class=" d-flex justify-content-center mb-4">
                ...
                <form method="post" action="/teacher_deleteevent/{{ $event->id }}" method="post" accept-charset="utf-8"
                    autocomplete="on">
                    @csrf
                    {{-- @method('DELETE') --}}
