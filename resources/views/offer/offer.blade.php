...
@section('content')
        ...
        <div class="row py-5">
            <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                <h1 class="display-4 animated zoomIn text-white"
                    style="margin-top: 150px">Offers</h1>
                <a href=""
        ...
        <div class="container py-5">
            ...
            <div class="row g-5">
                <div class="col-lg-6  wow zoomIn"
                    data-wow-delay="0.3s">
                    <div
                        class="service-item bg-light rounded d-flex flex-column align-items-center justify-content-center text-center h-100 bg-white rounded shadow position-relative"
                        style="z-index: 1;"">
    ...
    <div class="container-fluid py-5 wow fadeInUp"
        ...
        <div class="card mb-4"
            ...
            <div class="row no-gutters">
                <div class="text-center">
                    <img src="{{ url('images/hairdressing.jpg') }}"
                        class="rounded w-100"
                        alt="...">
                </div>
                <div class="col-md-12">
